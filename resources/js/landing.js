...
// FAQ accordion is initialized by initFAQAccordion() in landing.blade.php after FAQs are loaded
...
if (inquiryForm) {
    inquiryForm.addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch(`/inquiry?request_number=${requestNumber}`);
